...
# ✅ **4. Configure a restricted shell**
...
Try commands like `cd` — they should fail.
...
# ✅ **7. Configure /project directory with group collaboration**
...
Here’s a **realistic, exam-style combined scenario** that merges all user/group–related tasks into one workflow — exactly the kind of multi-step chain Red Hat expects you to handle under time pressure.
Following that, you’ll get **verification commands for every step** so you can confirm correctness like an examiner would.
...
## **1️⃣ Create a group called `devteam`.**

---

## **2️⃣ Create the following users with specific requirements:**
...
## **3️⃣ Lock the account `bob` temporarily.**

---

## **4️⃣ Create a project directory `/project` with the following rules:**
...
# 🚀 **Step-by-Step Commands (Full Solutions)**

---

# **1️⃣ Create the required groups**
...
# **4️⃣ Create and configure `/project` directory**
...
# ✅ **Verification Commands (Exactly what examiners check)**
